...
describe("FileSystemDatasource", () => {
  ...
  test('should send empty array', async () => {
    const logDatasource = new FileSystemDatasource();
  ...
  test('should throw error when severity level is different to: low, medium and high', async () => {
    const logDatasource = new FileSystemDatasource();

    const customSeverityLevel = 'different' as LogSeverityLevel;

    const errorExpected = new Error(`${customSeverityLevel} not implemented`);
