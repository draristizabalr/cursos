...
describe('CalculatorButtonComponent', () => {
  ...
  it('should apply w-1/2 doubleSize is true', () => {
    ...
    expect(hostCssClasses).toContain('w-1/2');
  ...
  it('should set isPressed to true and then false when keyboardPressStyle is called a matching key', (done) => {
  ...
  it('should display prohected content', () => {
    const testHostFixture = TestBed.createComponent(TestHostComponent);
    const compiledTest = testHostFixture.nativeElement as HTMLDivElement;
    const projectedContent = compiledTest.querySelector('.projected-content');
